...
close all
clc
load ('refs/sim_result2.mat');
load ('refs/TestTrack.mat');
load ('refs/RefTraj.mat');

video=0; %set to 1 for making video else 0

if video
v = VideoWriter('video/car_sim.avi','Motion JPEG AVI');
v.Quality = 95;
open(v);
end
